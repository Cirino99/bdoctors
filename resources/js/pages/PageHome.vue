<template>
    <div>
        <div class="d-flex justify-content-center flex-row p-5 bg-primary bg-gradient-bottom bg-opacity-50" id="bg-searchbar">
            <!-- searchbar -->
            <form class="d-flex justify-content-center gap-1 form-inline my-2 my-lg-0 w-75" id="form">
                ...
                <router-link :to="{name: 'AdvanceSearch', params: {specializationSelect: mySpecialization} }" id="search-button" class="btn btn-warning bg-opacity-25 my-2 my-sm-0 d-flex justify-content-center">
